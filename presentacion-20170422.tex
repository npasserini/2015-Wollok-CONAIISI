	...
	\begin{itemize}
		\item Sintaxis cuidada 
			\begin{itemize}
			  ...
			  \item énfasis en objetos y mensajes {\footnotesize (aunque no todo es objeto mensaje)}
			\end{itemize}
...
\frame{
	...
	\begin{itemize}
		...
		\item SCM:
			\begin{itemize}
			  	\item \textbf{Código}: \includegraphics[width=9pt,
...
\frame{
	...
	\begin{itemize}
    \item Debugger
    \item Diagramas: Clases y Objetos {\footnotesize (en desarrollo)}
    \item Tests
