...
\frame{
	...
	\begin{itemize}
    \item \textbf{Reporte de errores} adaptado e internacionalizado.
    \smallskip
    \item \textbf{Content assist, quick fixes, refactorings, formateo automático}.
    \smallskip
    \item \textbf{Testeo} automático integrado.
    \smallskip
    \item \textbf{Diagramas} estáticos (y dinámicos en proceso).
    \smallskip
